...
class Graph:
    ...
    def create_adjacency_map(self) -> Dict[int, Dict[int, float]]:
        ...
        # Vá lỗi KeyError 0: Khởi tạo khoảng cách 0 đến 0 bằng 0.0
        for node in nodes:
            adjacency_map[node] = {}
    ...
    def update_pheromone_map(self, best_solution):
        ...
        for index_1, node_1 in enumerate(nodes):
            for node_2 in nodes[index_1 + 1:]:
                new_value = max(round((1 - self.cfg.RHO) * self.pheromone_map[node_1][node_2], 5), 1e-10) 
...
class Ant:
    ...
    def find_solution(self):
        ...
        return Solution(self.routes, sum(self.total_path_cost))
